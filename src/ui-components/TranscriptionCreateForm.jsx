...
export default function TranscriptionCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setDateLastUpdated(initialValues.dateLastUpdated);
    setUserLastUpdated(initialValues.userLastUpdated);
    ...
    setDisableAnalyzer(initialValues.disableAnalyzer);
    setEditors(initialValues.editors);
    setCurrentEditorsValue("");
    setViewers(initialValues.viewers);
    setCurrentViewersValue("");
    setEditorGroups(initialValues.editorGroups);
    setCurrentEditorGroupsValue("");
    setViewerGroups(initialValues.viewerGroups);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Transcription(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "TranscriptionCreateForm")}
      {...rest}
    >
      <TextField
        label="Author"
